            ...
            <table id="projectTable" class="table table-hover align-middle" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <td>
    <a href="<?= base_url('projects/view/'.$p->id); ?>" class="fw-bold text-decoration-none text-primary">
    ...
    <small class="text-muted">Client: <?= $p->customer_name ?></small>
                        ...
                        <td>
                            <div class="d-flex flex-wrap gap-1">
                                <span class="badge bg-soft-primary text-primary border border-primary-subtle">C: <?= $p->carpenter ?: 'N/A' ?></span>
                                <span class="badge bg-soft-info text-info border border-info-subtle">P: <?= $p->painter ?: 'N/A' ?></span>
                                <span class="badge bg-soft-warning text-warning border border-warning-subtle">E: <?= $p->electrician ?: 'N/A' ?></span>
                            </div>
                        </td>
                        ...
                        <td>
                            <?php if($p->map_location): ?>
                                <a href="<?= $p->map_location ?>" target="_blank" class="btn btn-link btn-sm p-0 text-decoration-none">
                        ...
                        <td class="text-end">
                            <div class="btn-group shadow-sm">
                                ...
                                <a href="<?= base_url('projects/delete/'.$p->id); ?>" class="btn btn-sm btn-white border" onclick="return confirm('Archive this project?')">
